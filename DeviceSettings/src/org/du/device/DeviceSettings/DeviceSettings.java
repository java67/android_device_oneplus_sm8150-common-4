...
*
*/
package org.du.device.DeviceSettings;
...
import org.du.device.DeviceSettings.FileUtils;
import org.du.device.DeviceSettings.Constants;
import org.du.device.DeviceSettings.R;
import org.du.device.DeviceSettings.SuShell;
import org.du.device.DeviceSettings.SuTask;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.du.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
